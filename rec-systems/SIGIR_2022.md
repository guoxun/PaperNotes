# SIGIR 2022 | 推荐系统相关论文集锦

> **原文链接**: [https://zhuanlan.zhihu.com/p/509134127](https://zhuanlan.zhihu.com/p/509134127)  
> **点赞数**: 55  
> **平台**: 知乎专栏
...
参考AI box专栏SIGIR 2022 整理，精选了SIGIR-2022中我个人觉得比较重要的文章，供大家参考。笔者觉得有价值的文章，会标注*号, 重要价值会标注**号。
...
SIGIR 2022接受文章列表
sigir.org/sigir2022/program/accepted/

根据AI box专栏提供的词云图，可以看到今年研究方向依旧集中在Recommendation方向，也包括Retrieval、Query等方向；主要任务包括：Ranking、Cross-domain、Multi-Model/Behavior、Few-Shot、User modeling、Conversation等；热门技术包括：Neural Networks、Knowledge Graph、GNN、Contrastive Learning、Transformer等，其中基于Graph的方法依旧是今年的研究热点。
