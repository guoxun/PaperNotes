...
参考朱勇椿老师的文章，选取了我比较感兴趣的文章进行中文标注。我认为非常有价值的文章，会星号标注。
近几年，推荐系统是WWW上的重要主题，广泛受到了学术界以及工业界的关注。本文整理了WWW2022上推荐系统相关论文。WWW 2022组委会近日放出了正式接收论文清单。大会共收到了1822篇论文（Full Submission），接收323篇，录用率为17.7%。


本文主要整理了推荐系统方面论文，共计65篇。可以看到技术方面，因果推理、图推荐热度较高，今年时序推荐和可解释推荐内容也比较多。其中因果相关4篇、时序推荐13篇、基于图的推荐9篇、可解释推荐7篇、推荐系统中的bias 5篇、公平性和隐私保护4、冷启动3篇、基于自编码机3篇、跨领域2篇、多任务2篇、对比学习3篇、延迟反馈2篇、新闻推荐2篇、其他12篇。


注：完整清单见

Accepted Papers - TheWebConf 2022www2022.thewebconf.org/accepted-papers/www2022.thewebconf.org/accepted-papers/
