...
本文基于WSDM 2022论文《Personalized Transfer of User Preferences for Cross-domain Recommendation》，论文作者来自中科院计算所、腾讯微信、北航。推荐系统越来越渗透到各行业当中，如何快速地利用现有推荐系统能力来为不同业务带来收益，是一个有挑战且重要的方向。本文解读参考了论文作者朱勇椿老师的内容。
...
1.背景介绍
随着个性化线上app的增长，推荐系统被线上服务广泛采用，比如电商、线上新闻等场景。但是推荐系统无法给新（冷启动）用户提供精准的推荐服务。
